...
class UI {
    ...
    static mensajeAlerta(mensaje, className) {
...
//cargar el contenido al cargar la pagina
...
document.querySelector("#libro-form").addEventListener("submit", (e) => {
    ...
    if (titulo === "" || autor === "" || isbn === "") {
        UI.mensajeAlerta("Debes rellenar todos los campos", "danger")
    } else {
        const libro = new Libro(titulo, autor, isbn);
        Datos.agregarLibro(libro);
        UI.agregarLibroLista(libro);
        UI.mensajeAlerta("Libro agregado", "success")
        UI.limpiarCampos();
    }
});
...
document.querySelector("#libro-list").addEventListener("click", (e)=>{
    ...
    UI.mensajeAlerta("Libro eliminado", "warning");
})